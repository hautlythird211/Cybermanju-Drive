...
export const MODULE_METADATA: Record<PanelType, ModuleInfo> = {
  landing: { id: 'landing', label: 'HOME', icon: 'mdi:home-outline', color: '#FFFFFF', gradient: 'linear-gradient(180deg, #000000 0%, #0a0a0a 50%, #000000 100%)', description: 'Quantum-resistant encrypted file manager', requiresAuth: false },
  files: { id: 'files', label: 'FILES', icon: 'mdi:folder-outline', color: '#FFFFFF', gradient: 'linear-gradient(180deg, #000000 0%, #0a0a1a 50%, #000000 100%)', description: 'Browse and manage your encrypted files', requiresAuth: true },
  search: { id: 'search', label: 'SEARCH', icon: 'mdi:magnify', color: '#FFFFFF', gradient: 'linear-gradient(180deg, #000000 0%, #0a0a0a 50%, #000000 100%)', description: 'Tantivy BM25 full-text search', requiresAuth: true },
  collections: { id: 'collections', label: 'COLLECTIONS', icon: 'mdi:bookmark-multiple-outline', color: '#FFFFFF', gradient: 'linear-gradient(180deg, #000000 0%, #0d0800 50%, #000000 100%)', description: 'Curate and organize file collections', requiresAuth: true },
  faces: { id: 'faces', label: 'PEOPLE', icon: 'mdi:face-man-outline', color: '#FFFFFF', gradient: 'linear-gradient(180deg, #000000 0%, #0d0008 50%, #000000 100%)', description: 'AI face detection and clustering', requiresAuth: true },
  map: { id: 'map', label: 'MAP', icon: 'mdi:map-outline', color: '#FFFFFF', gradient: 'linear-gradient(180deg, #000000 0%, #000a0d 50%, #000000 100%)', description: 'GPS-tagged files on MapLibre GL', requiresAuth: true },
  code: { id: 'code', label: 'CODE', icon: 'mdi:code-tags', color: '#FFFFFF', gradient: 'linear-gradient(180deg, #000000 0%, #000d08 50%, #000000 100%)', description: 'Tree-sitter code intelligence', requiresAuth: true },
  sync: { id: 'sync', label: 'SYNC', icon: 'mdi:sync', color: '#FFFFFF', gradient: 'linear-gradient(180deg, #000000 0%, #00080d 50%, #000000 100%)', description: 'Multi-backend cloud sync', requiresAuth: true },
  accounts: { id: 'accounts', label: 'ACCOUNTS', icon: 'mdi:account-outline', color: '#FFFFFF', gradient: 'linear-gradient(180deg, #000000 0%, #0a0a0d 50%, #000000 100%)', description: 'Manage local and cloud accounts', requiresAuth: true },
  'loose-groups': { id: 'loose-groups', label: 'LOOSE', icon: 'mdi:file-group-outline', color: '#FFFFFF', gradient: 'linear-gradient(180deg, #000000 0%, #0d0d00 50%, #000000 100%)', description: 'Ad-hoc file grouping', requiresAuth: true },
  style: { id: 'style', label: 'TAGS', icon: 'mdi:tag-outline', color: '#FFFFFF', gradient: 'linear-gradient(180deg, #000000 0%, #0a000d 50%, #000000 100%)', description: 'CLIP-based visual style tags', requiresAuth: true },
  users: { id: 'users', label: 'USERS', icon: 'mdi:account-group-outline', color: '#FFFFFF', gradient: 'linear-gradient(180deg, #000000 0%, #0d0000 50%, #000000 100%)', description: 'Multi-user access control', requiresAuth: true },
  dashboard: { id: 'dashboard', label: 'REMOTE', icon: 'mdi:monitor-dashboard', color: '#FFFFFF', gradient: 'linear-gradient(180deg, #000000 0%, #00080d 50%, #000000 100%)', description: 'Web dashboard and API status', requiresAuth: true },
  webdash: { id: 'webdash', label: 'OVERLAY', icon: 'mdi:web', color: '#FFFFFF', gradient: 'linear-gradient(180deg, #000000 0%, #05050a 50%, #000000 100%)', description: 'Remote access dashboard', requiresAuth: true },
  preview: { id: 'preview', label: 'PREVIEW', icon: 'mdi:eye-outline', color: '#FFFFFF', gradient: 'linear-gradient(180deg, #000000 0%, #0a0a0a 50%, #000000 100%)', description: 'File preview panel', requiresAuth: true },
  encryption: { id: 'encryption', label: 'ENCRYPT', icon: 'mdi:lock-outline', color: '#FFFFFF', gradient: 'linear-gradient(180deg, #000000 0%, #0d0000 50%, #000000 100%)', description: 'Post-quantum encryption management', requiresAuth: true },
  compression: { id: 'compression', label: 'COMPRESS', icon: 'mdi:package-variant-closed', color: '#FFFFFF', gradient: 'linear-gradient(180deg, #000000 0%, #000d00 50%, #000000 100%)', description: 'Triple-layer compression pipeline', requiresAuth: true },
  settings: { id: 'settings', label: 'SETTINGS', icon: 'mdi:cog-outline', color: '#FFFFFF', gradient: 'linear-gradient(180deg, #000000 0%, #0a0a0a 50%, #000000 100%)', description: 'Application settings and preferences', requiresAuth: true },
  trash: { id: 'trash', label: 'TRASH', icon: 'mdi:delete-outline', color: '#FFFFFF', gradient: 'linear-gradient(180deg, #000000 0%, #0d0000 50%, #000000 100%)', description: 'Deleted files', requiresAuth: true },
  activity: { id: 'activity', label: 'ACTIVITY', icon: 'mdi:history', color: '#FFFFFF', gradient: 'linear-gradient(180deg, #000000 0%, #00080d 50%, #000000 100%)', description: 'File activity log', requiresAuth: true },
